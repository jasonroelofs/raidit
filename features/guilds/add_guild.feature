Feature: Adding a Guild
  ...
  @javascript
  Scenario: Users who add a new Guild adding a new character are given full permissions
    Given I am signed in as "raider"
    And I am at the home page
    When I follow "Characters"
    ...
    When I follow "Raids"
    Then the current guild should be "Weemopolis"
    And I should see "Schedule a Raid"
  ...
  @javascript
  Scenario: Users who add a new Guild updating a character are given full permissions
    Given I am signed in as "raid_leader"
    And I am at the home page
    And "raid_leader" has the following characters
      | name    | guild   |
